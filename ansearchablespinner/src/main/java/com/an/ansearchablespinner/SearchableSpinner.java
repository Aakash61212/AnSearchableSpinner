package com.an.ansearchablespinner;
...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
        SearchListDialog.SearchableItem {

    public static final int NO_ITEM_SELECTED = -1;
    private Context _context;
    private List _items;
    private SearchListDialog _searchableListDialog;
    ...
    private void init() {
        ...
        _searchableListDialog = SearchListDialog.newInstance
                (_items);
    ...
    public void setOnSearchTextChangedListener(SearchListDialog.OnSearchTextChanged onSearchTextChanged) {
