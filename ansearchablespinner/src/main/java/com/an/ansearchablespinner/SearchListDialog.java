...
public class SearchListDialog extends DialogFragment implements
    ...
    public static SearchListDialog newInstance(List items) {
        SearchListDialog multiSelectExpandableFragment = new
                SearchListDialog();
